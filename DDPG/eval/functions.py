...
def train(args, gen_net: nn.Module, dis_net: nn.Module, gen_optimizer, dis_optimizer, gen_avg_param, dis_avg_param, train_loader,
    ...
    for iter_idx, (imgs, _) in enumerate(tqdm(train_loader)):
        ...
        if global_steps % args.n_critic == 0:
            ...
            for p, avg_p in zip(dis_net.parameters(), dis_avg_param):
                avg_p.mul_(0.999).add_(0.001, p.data)
